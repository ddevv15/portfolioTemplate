...
export function ContactSection() {
  ...
  const socialLinks = [
    { label: "Github", url: "https://github.com/DevBrows25" },
    { label: "Instagram", url: "https://www.instagram.com/devbrows.official/" },
    { label: "LinkedIn", url: "https://www.linkedin.com/company/devbrows/" },
  ];
